...
- [Spring Service Loader Example](plugins/spring-service-loader-example) - Demonstrates how to use the Spring Service Loader plugin to dynamically load and configure event processors from Spring files at server startup.
